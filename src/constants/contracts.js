...
// XDC Testnet (Apothem)
export const Flip_CONTRACT_ADDRESS_APOTHEM = import.meta.env
  .VITE_APOTHEM_Flip_ADDRESS;
...
export const Flip_CONTRACT_ADDRESS_LOCAL =
  import.meta.env.VITE_LOCAL_Flip_ADDRESS || Flip_CONTRACT_ADDRESS_APOTHEM;
...
export const Flip_CONTRACT_ADDRESS =
  DEFAULT_NETWORK === 'mainnet'
    ? Flip_CONTRACT_ADDRESS_MAINNET
    : Flip_CONTRACT_ADDRESS_APOTHEM;
